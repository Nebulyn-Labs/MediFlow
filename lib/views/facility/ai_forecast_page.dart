                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              '${_historicalData.length} days loaded',
        ...
        lineBarsData: [
          LineChartBarData(
            ...
            belowBarData: BarAreaData(
              show: true,
              color: MediColors.info.withValues(alpha: 0.08),
            ),
          ),
          if (forecastSpots.isNotEmpty)
            LineChartBarData(
