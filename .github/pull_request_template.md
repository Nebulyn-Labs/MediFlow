...
## Screenshots / Visual Proof (Required for UI Changes)

If this PR affects the UI (looks, layout, animations), please attach
screenshots or a screen recording showing the changes.
